...
async function test() {
  ...
  console.log(
    "Request:",
    pp({ holderId, publicKey: keyPair.publicKey.substring(0, 40) + "..." }),
  );
  ...
  console.log(
    "Request:",
    pp({ ...loginBody, signature: signature.substring(0, 40) + "..." }),
  );
  ...
  console.log(
    "Response:",
    pp({ ...loginData, token: token.substring(0, 50) + "..." }),
  );
  console.log(
    "└──────────────────────────────────────────────────────────────┘\n",
  );
  ...
  console.log(
    "Headers: Authorization: Bearer <token>, X-Wallet-Passphrase: ***",
  );
